...
class LostBusActivity : Activity() {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val task = GetXMLTask()
        val api_key = "6762557a6369797335314677466e58"
        val url = "http://openapi.seoul.go.kr:8088/$api_key/xml/ListLostArticleService/1/200/b1/"
        task.execute(url)
    }
