...
class LostTaxiActivity : Activity() {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val task = GetXMLTask()
        val api_key = "6e4b69634569797338307141446644"
        val url = "http://openapi.seoul.go.kr:8088/$api_key/xml/ListLostArticleService/1/200/t1/"
        task.execute(url)
    }
