...
import com.keelim.practice10.model.adapter.ItemCategoryListRecyclerAdapter;
import com.keelim.practice10.utils.JSONTask;
import com.keelim.practice10.view.ItemAddActivity;
import com.keelim.practice10.model.adapter.ItemListRecyclerAdapter;
...
public class ItemManagementFragment extends Fragment{
    ...
    public ItemManagementFragment(@NonNull Store store) {
        this.store = store;
    ...
    @NonNull
    public static ItemManagementFragment newInstance(int sectionNumber, @NonNull Store store) {
                ...
                holder.cardview.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if(deleteList.size()==0)
                            checkFlg = false;
                        if(!ItemManagementFragment.checkFlg) {
