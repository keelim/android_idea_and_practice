...
public class ItemAddActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //뒤로가기
        ((ImageButton)findViewById(R.id.backButton)).setOnClickListener((View.OnClickListener) v -> finish());
        ...
        ((LinearLayout)findViewById(R.id.order_clothes_basket)).setOnClickListener((View.OnClickListener) v -> {
            int value;
            try{
        ...
        ((LinearLayout)findViewById(R.id.order_clothes_reserve)).setOnClickListener((View.OnClickListener) v -> {
