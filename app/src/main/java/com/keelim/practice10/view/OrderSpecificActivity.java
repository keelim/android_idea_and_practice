...
import com.keelim.practice10.model.adapter.OrderSpecificRecyclerAdapter;
import com.keelim.practice10.utils.JSONTask;
import com.keelim.practice10.view.fragment.OrderFragmentManagementFragment;
import com.keelim.practice10.view.fragment.OrderFragmentManagementFragment2;
...
public class OrderSpecificActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (item.getAcceptStatus() == 0) {
            ...
            btnDelete.setOnClickListener(v -> showAlert(context, item));
        }
    ...
    private void showAlert(final Context context, @NonNull final Order order){
        ...
        builder.setNegativeButton("아니오",
                (dialog, which) -> Toast.makeText(context, "취소되었습니다.", Toast.LENGTH_SHORT).show());
        builder.show();
    }
}
