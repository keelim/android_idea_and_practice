...
import com.keelim.practice10.model.retrofit.ImageInfo;
import com.keelim.practice10.model.retrofit.RetrofitInterface;
...
public class ServerImg {
    ...
    // 고객기준
    // 상점 이미지 가져오기
    public static void getStoreImageGlide(@NonNull Context context, int storeID, @NonNull ImageView imageView){
        Glide.with(context)
    ...
    // 옷 이미지 가져오기
    public static void getClothesImageGlide(@NonNull Context context, int clothesID, @NonNull ImageView imageView){
    ...
    // 대여점 기준
    // 상점 이미지 가져오기
    public static void getAdminStoreImageGlide(@NonNull Context context, int storeID, @NonNull ImageView imageView){
        Glide.with(context)
                .load(BaseURL + "store/" + storeID +".jpg")
                .apply(new RequestOptions()
                                .diskCacheStrategy(DiskCacheStrategy.NONE)
    ...
    // 옷 이미지 가져오기
    public static void getAdminClothesImageGlide(@NonNull Context context, int clothesID, @NonNull ImageView imageView){
        Glide.with(context).load(BaseURL + "cloth/" + clothesID +".jpg")
                .apply(new RequestOptions()
                                .diskCacheStrategy(DiskCacheStrategy.NONE)
                                .fitCenter()
    ...
    public static void uploadFile(Uri fileUri, @NonNull String storeID, @NonNull String clothesID, final Context context) {
    ...
    public static void uploadFileOnPath(@NonNull String path, @NonNull String storeID, @NonNull String clothesID, final Context context) {
