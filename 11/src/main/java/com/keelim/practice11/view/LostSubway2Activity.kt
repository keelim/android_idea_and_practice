...
class LostSubway2Activity : Activity() {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val task = GetXMLTask()
        val api_key = "63666c516869797334384f48535866"
        val url = "http://openapi.seoul.go.kr:8088/$api_key/xml/ListLostArticleService/1/5/s2/"
        task.execute(url)
    }
