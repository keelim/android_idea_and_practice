...
class LostTaxi2Activity : Activity() {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val task = GetXMLTask()
        val api_key = "6154614f5869797336387955776172"
        val url = "http://openapi.seoul.go.kr:8088/$api_key/xml/ListLostArticleService/1/200/t2/"
        task.execute(url)
    }
